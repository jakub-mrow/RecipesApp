...
class CakeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        cakeRecipeList = ArrayList()

        mRecyclerViewAdapter = RecipeRecyclerAdapter(cakeRecipeList)
        ...
        val cakeRecipeCall: Call<ArrayList<Recipe>> = api.getCakeRecipes()

        cakeRecipeCall.enqueue(object: Callback<ArrayList<Recipe>?> {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mRecyclerViewAdapter.setOnItemClickListener(object : RecipeRecyclerAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                val bundle = Bundle()
                val currentRecipe: Recipe = cakeRecipeList.get(position)
